...
CREATE TABLE `itens` (
  ...
  `item_emprestado` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
  `devedor` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2022-11-23  8:51:46
